...
https://arcade.academy/examples/conway_alpha.html#conway-alpha
"""
import arcade
import random
...
# SCREEN_WIDTH = ((CELL_WIDTH + CELL_MARGIN) * COLUMN_COUNT + CELL_MARGIN) // 2
# SCREEN_HEIGHT = ((CELL_HEIGHT + CELL_MARGIN) * ROW_COUNT + CELL_MARGIN) // 2
