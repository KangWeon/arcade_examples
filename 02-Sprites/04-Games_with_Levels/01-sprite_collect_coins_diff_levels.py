...
https://arcade.academy/examples/sprite_collect_coins_diff_levels.html#example-sprite-collect-coins-diff-levels
"""
...
class MyGame(arcade.Window):
    ...
    def level_2(self):
        for i in range(30):
            ...
            coin = FallingCoin(":resources:images/items/coinGold.png", SPRITE_SCALING / 2)
    ...
    def level_3(self):
        for i in range(30):
            ...
            # Create the coin instance
            coin = RisingCoin(":resources:images/items/coinGold.png", SPRITE_SCALING / 2)
